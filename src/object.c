...
void printobject(op, fp, flags)object* op;
							   FILE* fp;
							   int flags;
{
...
object* getattr(v, name)object* v;
						char* name;
{
...
static void none_print(op, fp, flags)object* op;
									 FILE* fp;
									 int flags;
{
	(void) op;
...
static typeobject Notype = {
		OB_HEAD_INIT(&Typetype) 0, "None", 0, 0,
