...
object* newmoduleobject(name)char* name;
{
...
object* getmoduledict(m)object* m;
{
...
static object* module_repr(m)moduleobject* m;
{
	char buf[100];
...
static object* module_getattr(m, name)moduleobject* m;
									  char* name;
{
	object* res;
