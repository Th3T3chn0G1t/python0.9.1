...
void printnonterminals(g, fp)grammar* g;
							 FILE* fp;
{
	dfa* d;
	int i;
...
static void printstates(g, fp)grammar* g;
							  FILE* fp;
{
	state* s;
	dfa* d;
...
static void printdfas(g, fp)grammar* g;
							FILE* fp;
{
	dfa* d;
	int i, j;
...
static void printlabels(g, fp)grammar* g;
							  FILE* fp;
{
	label* l;
	int i;
