...
static object* mac_chdir(self, args)object* self;
									object* args;
{
	object* path;
...
static object* mac_listdir(self, args)object* self;
									  object* args;
{
	object* name, * d, * v;
	DIR* dirp;
...
static object* mac_mkdir(self, args)object* self;
									object* args;
{
	object* path;
	int mode;
...
static object* mac_rename(self, args)object* self;
									 object* args;
{
	object* src, * dst;
...
static object* mac_rmdir(self, args)object* self;
									object* args;
{
	object* path;
	if(!getstrarg(args, &path)) {
...
static object* mac_stat(self, args)object* self;
								   object* args;
{
	struct stat st;
	object* path;
...
static object* mac_sync(self, args)object* self;
								   object* args;
{
	if(!getnoarg(args)) {
		return NULL;
...
static object* mac_unlink(self, args)object* self;
									 object* args;
{
	object* path;
	if(!getstrarg(args, &path)) {
