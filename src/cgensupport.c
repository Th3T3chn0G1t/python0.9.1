...
object* mknewcharobject(c)int c;
{
	char ch[1];
	ch[0] = c;
...
int getistringarg(args, nargs, i, p_arg)object* args;
										int nargs, i;
										string* p_arg;
{
	object * v;
...
int getichararg(args, nargs, i, p_arg)object* args;
									  int nargs, i;
									  char* p_arg;
{
	string x;
...
int getilongarraysize(args, nargs, i, p_arg)object* args;
											int nargs, i;
											long* p_arg;
{
	object * v;
...
int getishortarraysize(args, nargs, i, p_arg)object* args;
											 int nargs, i;
											 short* p_arg;
{
	long x;
...
int getilongarray(args, nargs, i, n, p_arg)object* args;
										   int nargs, i;
										   int n;
										   long* p_arg; /* [n] */
{
...
int getishortarray(args, nargs, i, n, p_arg)object* args;
											int nargs, i;
											int n;
											short* p_arg; /* [n] */
{
...
int getidoublearray(args, nargs, i, n, p_arg)object* args;
											 int nargs, i;
											 int n;
											 double* p_arg; /* [n] */
{
...
int getifloatarray(args, nargs, i, n, p_arg)object* args;
											int nargs, i;
											int n;
											float* p_arg; /* [n] */
{
