...
def browserhelp():
    ...
    print
    '    using the current level\'s symbol tables'
    print
...
def readfileline(filename, lineno):
    ...
    if _filecache.has_key(filename):
        ...
        if stat[ST_SIZE] = cached_stat[ST_SIZE] and \
            ...
            print
            'Stale cache entry for', filename
    ...
    if 0 <= lineno - 1 < len(lines):
        ...
        print
        'Line number out of range, last line is', len(lines)
        return ''
