...
class Room():
    ...
    def describe(here):
        if not here.description:
            ...
            for line in here.description: print
            line
        here.listobjects()
    ...
    def listexits(here):
        ...
        if there:
            if len(there) = 1:
                print
                'There is an exit leading',
            else:
                print
                'There are exits leading',
                for name in there[:-2]:
                    print
                    name + ',',
                print
                there[len(there) - 2], 'and',
            print
            there[len(there) - 1] + '.'
    ...
    # Standard exits.
    def north(here):
        return here.take_exit(N)

    def south(here):
        return here.take_exit(S)

    def west(here):
        return here.take_exit(W)

    def east(here):
        return here.take_exit(E)

    def up(here):
        return here.take_exit(U)

    def down(here):
        return here.take_exit(D)

    def nw(here):
        return here.take_exit(NW)

    def ne(here):
        return here.take_exit(NE)

    def sw(here):
        return here.take_exit(SW)

    def se(here):
        return here.take_exit(SE)
